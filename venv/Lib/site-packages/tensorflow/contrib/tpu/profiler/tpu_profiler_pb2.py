...
_PROFILERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tool_data', full_name='tensorflow.ProfileResponse.tool_data', index=5,
